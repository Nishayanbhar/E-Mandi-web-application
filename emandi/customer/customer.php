         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-1" style="margin-top: 0px;">
               <ul class="nav navbar-nav">
                  <li><a href="customer.php" class="dropdown-toggle" >Home</a></li>
                                        ...
                                        while($row = mysqli_fetch_assoc($result))
                                            ...
                                            echo '<div class="col-md-3 col-sm-3 col-xs-12" >
											  ...
											  <div class="border border-dark" style="height:246px;">
                                                  <img src="../farmer/'.$image.'" alt="" style="max-width:100%;max-height:100%;">
                                                 </div>
                                                  ...
                                                  <div class="hot-wid-rating">
													...
													<h4 style="color:red;margin-left:3%;font-weight:bold;font-size:20px;">₹'.$price.'</h4>
                                                      <h4><a href="singlepro.php?vegname='.$vegname.'&&ad='.$adhar.'&&id='.$id.'" style="color:black;margin-left:33%;font-weight:bold;font-size:15px;">'.
                                                      $vegname.'
                                                      </a></h4>
											...
											else
											{
											  ...
											  <div class="border border-dark" style="height:246px;">
                                                  ...
                                                  <div class="hot-wid-rating">
                                                    ...
                                                    <form method="post" action="singlepro.php?vegname='.$vegname.'&&ad='.$adhar.'&&id='.$id.'">
