            ...
            <div class="row">
                 <div class="col-md-5 col-sm-5 col-xs-12">
                    ...
                    <div class="summary">
                        ...
                        <?php
                        include 'config.php';
                                    $result = mysqli_query($link,"select * from cart where user_adharno='$adharno'");
                                    $total=0;
                ...
                <div class="col-md-5 col-sm-5 col-xs-12">
                    ...
                    <div class="Shipping" id="shippingadd">
                      <input type="radio" name="isPrimary" id="member_1" checked onclick="javascript:show2();"> Ship to Primary Address
                      <input type="radio" name="isPrimary" id="member_0" onclick="javascript:show1();"> Ship to New Address
                      <div id="old">
						<div  class="ship-single" >
							
                              <input type="text" name="name" placeholder="Full Name" id="name" value="<?php echo $name;?>">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="payment">
                    <div class="bank">
                        <input type="radio" hhidden name="optradio">&nbsp&nbsp Direct Bank Transfer<br>
