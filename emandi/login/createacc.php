...
if(empty($name_err) && empty($password_err) && empty($confirm_password_err) && empty($adharno_err) && empty($city_err && empty($mobile_err)))
{ 
...
function showHint(str) {
  if (str== 0) {
    ...
    xmlhttp.open("GET", "bhumiauth.php?bhm=" + str, true);
    xmlhttp.send();
  }
}
...
<div class="wrapper">
    ...
    <p>Please fill this form to create an account.</p>
	 <div class="form-group <?php echo (!empty($role_err)) ? 'has-error' : ''; ?>">
					<input type="radio"  name="role"  onclick="javascript:show2();" value="3" />
							FARMER
					<input type="radio"  name="role"  onclick="javascript:show1();" value="4" />
							CUSTOMER
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
		<div class="form-group <?php echo (!empty($bhumi_err)) ? 'has-error' : ''; ?>">
            ...
            <input type="text" name="bhumino" class="form-control" onkeyup="showHint(this.value)" value="<?php echo $bhumino; ?>" >
